...
<body>
    ...
    <main xpath="1">
        <div id="myCarousel" class="carousel slide mb-6" data-bs-ride="carousel" bis_skin_checked="1">
            <div class="carousel-indicators" bis_skin_checked="1"> <button type="button" data-bs-target="#myCarousel"
                    data-bs-slide-to="0" class="" aria-label="Slide 1"></button> <button type="button"
                    data-bs-target="#myCarousel" data-bs-slide-to="1" aria-label="Slide 2" class="active"
                    aria-current="true"></button> <button type="button" data-bs-target="#myCarousel"
                    data-bs-slide-to="2" aria-label="Slide 3" class=""></button> </div>
            <div class="carousel-inner" bis_skin_checked="1">
                <div class="carousel-item" bis_skin_checked="1"> <svg aria-hidden="true" class="bd-placeholder-img "
                ...
                <div class="carousel-item active" bis_skin_checked="1"> <svg aria-hidden="true"
                        class="bd-placeholder-img " height="100%" preserveAspectRatio="xMidYMid slice" width="100%"
                        xmlns="http://www.w3.org/2000/svg">
                        <rect width="100%" height="100%" fill="var(--bs-secondary-color)"></rect>
                    </svg>
                    <div class="container" bis_skin_checked="1">
  ...
  ================================================== -->
        ...
        <div class="container marketing" bis_skin_checked="1">
            ...
            <div class="row" bis_skin_checked="1">
                <div class="col-lg-4" bis_skin_checked="1"> <svg aria-label="Placeholder"
            ...
            <div class="row featurette" bis_skin_checked="1">
                ...
                <div class="col-md-5" bis_skin_checked="1"> <svg aria-label="Placeholder: 500x500"
            ...
            <div class="row featurette" bis_skin_checked="1">
                ...
                <div class="col-md-5 order-md-1" bis_skin_checked="1"> <svg aria-label="Placeholder: 500x500"
                        class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" height="500"
                        preserveAspectRatio="xMidYMid slice" role="img" width="500" xmlns="http://www.w3.org/2000/svg">
                        <title>Placeholder</title>
                        <rect width="100%" height="100%" fill="var(--bs-secondary-bg)"></rect><text x="50%" y="50%"
